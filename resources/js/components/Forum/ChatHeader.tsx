        ...
        <div
            ...
            style={
                isMentorOrAdmin
                    ? undefined
                    : {
                          background: 'linear-gradient(to bottom, #3B28F6 0%, #4c2fff 30%, #7c3aed 50%, #facc15 100%)',
                      }
            }
        >
            <div className={`flex items-center justify-between bg-white dark:bg-[#0f0e0e] transition-colors duration-300 px-4 py-3 ${
                isMentorOrAdmin
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className={`relative z-10 mr-2 flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border transition-colors md:hidden active:scale-95 ${
                            isMentorOrAdmin
                                ...
                                : 'border-blue-500 bg-blue-100 hover:border-blue-600 hover:bg-blue-200 dark:border-blue-800 dark:bg-[#0b1021] dark:hover:border-blue-600 dark:hover:bg-blue-900/40 text-indigo-600 dark:text-indigo-500'
                        }`}
                    >
                        {isMentorOrAdmin ? (
                            <ArrowLeft className="h-5 w-5" />
                        ) : (
                            <svg viewBox="0 0 48 48" className="h-7 w-7 scale-125 transition-transform duration-200 hover:scale-150">
                    ...
                    <div className={`h-9 w-9 md:h-10 md:w-10 overflow-hidden rounded-xl border bg-slate-900 transition-all duration-300 hover:scale-105 ${
                        isMentorOrAdmin ? 'border-slate-350 dark:border-slate-700' : 'border-[#3B28F6]/40'
                    }`}>
                    ...
                    <div>
                        ...
                        <p className={`text-[10px] font-semibold ${
                            isMentorOrAdmin ? 'text-slate-500 dark:text-slate-400' : 'text-indigo-600 dark:text-[#facc15]'
                        }`}>
                            Diskusi Kelas Aktif
                        </p>
                    </div>
