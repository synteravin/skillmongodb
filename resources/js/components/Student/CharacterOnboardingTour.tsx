...
export default function CharacterOnboardingTour({
    ...
    const steps: Step[] = [
        {
            ...
            icon: BookOpen,
            message:
                'Di bagian MY COURSE, kamu akan menemukan seluruh peta pembelajaran (roadmap) dan materi interaktif yang dirancang khusus untuk mengasah skill teknismu.',
        },
        {
            title: 'MY COURSE',
            targetId: 'nav-item-my-course',
            icon: BookOpen,
            message:
                'Setiap modul dilengkapi dengan video, modul bacaan, dan kuis praktis. Selesaikan semuanya untuk meningkatkan level RPG-mu dan mengumpulkan EXP!',
        },
        {
            title: 'QUEST BOARD',
            ...
            icon: Briefcase,
            message:
                'QUEST BOARD adalah papan pekerjaan tempat kamu bisa melamar dan mengambil proyek freelance nyata dari klien industri.',
        },
        {
            title: 'QUEST BOARD',
            targetId: 'nav-item-quest',
            icon: Briefcase,
            message:
                'Selesaikan proyek dengan hasil terbaik untuk mendapatkan imbalan Gold melimpah serta poin reputasi ERP (Enterprise Reputation Points)!',
        },
        {
            title: 'TIER LIST',
            ...
            icon: Award,
            message:
                'Menu TIER LIST menampilkan peringkat persaingan seluruh siswa secara real-time. Buktikan kemampuanmu dan capai posisi puncak!',
        },
        {
            title: 'TIER LIST',
            targetId: 'nav-item-tier-list',
            icon: Award,
            message:
                'Terus kumpulkan reputasi ERP dari Quest dan aktivitas belajar untuk menaikkan bintangmu dan membuka Rank tertinggi!',
        },
        {
            title: 'CERTIFICATE',
            ...
            icon: Compass,
            message:
                'Semua sertifikat kelulusan, lisensi keahlian, dan pencapaian resmi yang telah kamu perjuangkan di SkillVentura akan disimpan secara permanen di sini.',
        },
        {
            ...
            icon: Users,
            message:
                'Gunakan FORUM KOMUNITAS untuk berdiskusi dengan mentor, mengajukan pertanyaan seputar materi, dan berjejaring dengan kawan petualang lainnya.',
        },
        {
            title: 'FORUM KOMUNITAS',
            targetId: 'nav-item-forum',
            icon: Users,
            message:
                'Selamat! Kamu telah mempelajari seluruh fitur navigasi dasar. Selesaikan panduan ini sekarang untuk langsung mengklaim hadiah awalmu!',
        },
    ];
    ...
    return (
        <div className="pointer-events-none fixed inset-0 z-40 overflow-hidden">
            ...
            <div className="pointer-events-auto absolute top-0 right-0 bottom-[44px] left-0 z-10 bg-[#020202]/65 md:bottom-[64px] lg:bottom-[80px]" />
            {/* Discreet Skip Button (Pill badge minimalis & discreet) */}
            <button
                onClick={() => finishTour(false)}
                disabled={isSubmitting}
                className="pointer-events-auto absolute top-3.5 right-3.5 z-50 flex cursor-pointer items-center gap-1.5 rounded-full border border-slate-800/40 bg-slate-950/40 px-2.5 py-1 font-['Orbitron'] text-[9.5px] font-medium text-slate-400/60 opacity-50 backdrop-blur-xs transition-all duration-300 select-none hover:border-slate-700/70 hover:bg-slate-900/80 hover:text-slate-200 hover:opacity-100 md:top-4 md:right-4 md:px-3 md:py-1 md:text-xs"
                title="Lewati Panduan"
            >
                <span className="xs:inline hidden">Lewati Panduan</span>
            ...
            <div className={welcomeBubbleClass}>
                <div className="relative w-full">
                    <div className="xs:p-2.5 relative w-full rounded-2xl border border-[#3B28F6]/40 bg-gradient-to-b from-[#0b0903]/95 to-[#070b24]/95 p-2 text-slate-100 shadow-[0_0_15px_-3px_rgba(59,40,246,0.5)] backdrop-blur-sm select-none sm:p-3 md:p-2.5 lg:p-4">
                        {/* Top accent line */}
                        <div className="absolute top-0 right-3 left-3 h-px bg-gradient-to-r from-transparent via-amber-400/70 to-transparent" />
                        <h4 className="xs:text-[8px] mb-0.5 flex items-center gap-1 font-['Orbitron'] text-[7.5px] font-extrabold tracking-wider text-amber-400 uppercase sm:mb-1 sm:text-[10px] md:text-[9px] lg:text-xs">
                            <span className="inline-block h-1 w-1 animate-pulse rounded-full bg-amber-400 shadow-[0_0_6px_2px_rgba(251,191,36,0.7)]" />
                            LEVEL UP YOUR LIFE! ✨
                        </h4>
                        <p className="xs:text-[8.5px] font-['Outfit',sans-serif] text-[8px] leading-relaxed text-slate-300 sm:text-[9.5px] md:text-[9.5px] lg:text-[11px]">
                            Aku{' '}
                            <span className="font-semibold text-[#7c6bff]">
                                {character.name}
                            </span>
                            , pemandu pribadimu! Aku akan memandumu di Ventura
                            ini langkah demi langkah untuk menjadi{' '}
                    ...
                    <div className="xs:left-8 absolute -bottom-1.5 left-6 h-3 w-3 rotate-45 border-r border-b border-[#3B28F6]/40 bg-[#070b24] sm:h-3.5 sm:w-3.5 md:left-10 lg:left-14" />
                </div>
            </div>
            ...
            <div className={mainCardClass}>
                <div className="xs:p-3 relative rounded-2xl border border-[#3B28F6]/40 bg-gradient-to-b from-[#0b0903]/95 to-[#070b24]/95 p-2.5 text-slate-200 shadow-[0_0_15px_-3px_rgba(59,40,246,0.5)] backdrop-blur-sm sm:p-4 md:p-3.5 lg:p-6">
                    ...
                    {!isMobileLandscape && (
                        <div className="xs:text-[8px] mb-1.5 flex animate-pulse items-center justify-center gap-1 rounded-lg border border-amber-500/30 bg-amber-500/10 px-1.5 py-0.5 font-['Orbitron'] text-[7.5px] font-extrabold text-amber-400 md:hidden">
                            <Gift size={10} />
                            <span>
                                Hadiah Awal: Klaim +60 EXP | +60 Gold | +35 ERP
                                saat Selesai!
                            </span>
                        </div>
                    )}
                    ...
                    <div className="mt-2 flex items-center justify-between border-t border-[#3B28F6]/20 pt-2 sm:mt-3 sm:pt-2 md:mt-2.5 md:pt-2 lg:mt-4 lg:pt-3">
                        {/* Back Button */}
                        {currentStepIndex > 0 ? (
                            <button
                                onClick={handleBack}
                                disabled={isSubmitting}
                                className="xs:text-[8px] inline-flex cursor-pointer items-center gap-0.5 font-['Orbitron'] text-[7.5px] font-bold text-[#0A84FF] transition duration-300 hover:underline disabled:opacity-50 sm:gap-1 sm:text-[9.5px] md:text-[9.5px] lg:text-xs"
                            >
                                <ChevronLeft size={10} />
                                <span>Kembali</span>
                            </button>
                        ) : (
                            <div className="h-5 w-8" /> /* placeholder to preserve alignment */
                        )}
                        ...
                        <button
                            onClick={handleNext}
                            disabled={isSubmitting}
                            className="xs:px-2.5 xs:py-1 xs:text-[8px] inline-flex cursor-pointer items-center gap-1 rounded-lg bg-gradient-to-r from-indigo-600 to-[#0A84FF] px-2 py-0.5 font-['Orbitron'] text-[7.5px] font-bold text-[#FFFFFF] shadow-md transition duration-300 hover:scale-105 active:scale-95 disabled:opacity-50 sm:px-3 sm:py-1 sm:text-[9.5px] md:text-[9.5px] lg:text-xs"
                        >
                            <span>
            ...
            <div className={rewardsCardClass}>
                ...
                <div className="relative w-full rounded-2xl border border-amber-400/50 bg-gradient-to-b from-[#0b0903]/95 to-[#070b24]/95 p-3.5 text-slate-200 shadow-[0_0_20px_rgba(245,158,11,0.2)] select-none md:p-2.5 lg:p-3.5 xl:p-4">
                    {/* Icon Badge at Top-Left */}
                    <div className="absolute -top-4 -left-4 flex h-9 w-9 items-center justify-center md:h-7 md:w-7 lg:h-9 lg:w-9 xl:h-10 xl:w-10">
                        <svg
                            viewBox="0 0 100 100"
                            className="h-full w-full drop-shadow-[0_0_8px_rgba(245,158,11,0.7)]"
                        >
                            {/* Circuit trace lines */}
                            <line
                                x1="0"
                    ...
                    <h4 className="mb-1 pt-1 font-['Orbitron'] text-[8px] font-extrabold tracking-wider text-amber-400 uppercase md:text-[7.5px] lg:text-[8px] xl:text-[9px]">
                        Reward Menunggu
                    </h4>
                    <p className="font-sans text-[9.5px] leading-relaxed font-medium text-slate-300 md:text-[8.5px] lg:text-[9.5px] xl:text-[11px]">
                        Ikuti setiap langkah panduanku untuk membuka{' '}
                        <span className="font-extrabold text-amber-400">
                            semua fitur dan hadiah!
                        </span>
                    </p>
                </div>
                ...
                <div className="relative my-1 flex flex-col items-center">
                    <div className="h-5 w-0.5 border-r-2 border-dashed border-[#3B28F6]/40 xl:h-6" />

                    {/* Hexagon Gift Box Container */}
                    <div className="relative flex h-14 w-14 shrink-0 items-center justify-center xl:h-18 xl:w-18">
                        ...
                        <svg
                            viewBox="0 0 8 8"
                            className="absolute -top-2 -left-3 h-2.5 w-2.5 fill-amber-400 drop-shadow-[0_0_5px_rgba(245,158,11,0.9)] xl:h-3 xl:w-3"
                        >
                            <path d="M4 0 L4.9 3.1 L8 4 L4.9 4.9 L4 8 L3.1 4.9 L0 4 L3.1 3.1 Z" />
                        </svg>
                        <svg
                            viewBox="0 0 8 8"
                            className="absolute top-1 -right-3 h-2 w-2 fill-amber-400 drop-shadow-[0_0_5px_rgba(245,158,11,0.9)] xl:h-2.5 xl:w-2.5"
                        >
                            <path d="M4 0 L4.9 3.1 L8 4 L4.9 4.9 L4 8 L3.1 4.9 L0 4 L3.1 3.1 Z" />
                        </svg>
                        <svg
                            viewBox="0 0 8 8"
                            className="absolute -right-1 -bottom-2 h-2.5 w-2.5 fill-amber-400 drop-shadow-[0_0_5px_rgba(245,158,11,0.9)] xl:h-3 xl:w-3"
                        >
                            <path d="M4 0 L4.9 3.1 L8 4 L4.9 4.9 L4 8 L3.1 4.9 L0 4 L3.1 3.1 Z" />
                        </svg>
                        ...
                        <svg
                            viewBox="0 0 100 100"
                            className="absolute inset-0 h-full w-full overflow-visible drop-shadow-[0_0_10px_rgba(59,40,246,0.6)]"
                        >
                            <polygon
                        ...
                        <div
                            className="absolute inset-[6px] flex items-center justify-center bg-gradient-to-b from-[#0b0903]/95 to-[#070b24]/95"
                            style={{
                                clipPath:
                        ...
                        >
                            <Gift
                                className="h-6 w-6 text-[#9d8fff] drop-shadow-[0_0_14px_rgba(157,143,255,1)] xl:h-8 xl:w-8"
                                strokeWidth={1.75}
                            />
                        </div>
                    </div>
                ...
                {showRewardModal && (
                    <>
                        ...
                        <motion.div
                            ...
                            animate={{ opacity: 1 }}
                            exit={{ opacity: 0 }}
                            className="pointer-events-auto fixed inset-0 z-50 bg-[#000514]/85 backdrop-blur-md"
                        />
                        ...
                        >
                            <div
                                ...
                                style={{
                                    ...
                                    boxShadow:
                                        '0 0 0 1px rgba(59,40,246,0.2), 0 0 40px rgba(59,40,246,0.5), inset 0 1px 0 rgba(96,165,250,0.1)',
                                }}
                            >
                                {/* Header Title */}
                                <div className="mb-2">
