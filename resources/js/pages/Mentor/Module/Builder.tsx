...
/* ================= MAIN ================= */
export default function ModuleBuilder({ path, group }: { group: CareerGroup; path: Path }) {
    ...
    const submitYoutube = (module: Module) => {
        ...
        router.post(`/mentor/modules/${getId(module)}/contents`, {
            type,
            url: youtubeUrl
        }, {
            preserveScroll: true,
    ...
    const addContent = (module: Module, type: ContentType) => {
        ...
        if (type === "text") {
            ...
            router.post(`/mentor/modules/${getId(module)}/contents`, { type }, {
                preserveScroll: true,
                onSuccess: () => router.reload({ only: ["path"] }),
                onError: () => rollback(module, tempId)
            });
    ...
    const saveContent = (content: ModuleContent) => {
        router.put(`/mentor/module-contents/${getId(content)}`, {
