        ...
        <AppLayout>
            ...
            >
                <div className="mx-auto w-full space-y-6 sm:space-y-8">
                    {/* HEADER */}
                    <header
                        className="relative w-full overflow-hidden rounded-xl border border-slate-300 bg-white px-6 py-5 shadow-sm backdrop-blur-xl dark:border-slate-800/60 dark:bg-slate-900/50 dark:shadow-lg"
                        style={{
                            backgroundImage: `
                    ...
                    <div className="space-y-6">
                        {questions.length === 0 ? (
                            <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-300 bg-white p-12 text-center shadow-sm dark:border-slate-800/60 dark:bg-slate-900/20">
                                ...
                                />
                                <h3 className="mb-1 text-lg font-semibold text-slate-800 dark:text-slate-300">
                                    No questions yet
                                </h3>
            ...
            <div className="space-y-6 p-5 sm:p-6">
                ...
                <div>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        {data.media_file && (
                            <span className="max-w-[200px] truncate py-2.5 text-sm text-slate-600 sm:max-w-xs dark:text-slate-400">
                        ...
                        {data.media_url && (
                            <button
                                ...
                                className="ml-auto cursor-pointer rounded-xl p-2.5 text-rose-500 transition-colors hover:bg-rose-100"
                                title="Remove Image"
                            >
                                <X size={16} />
                            </button>
                ...
                <div className="border-t border-slate-200 pt-4 dark:border-slate-800/60">
                        ...
                        {data.answers.map((a, i) => (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="dark:hover:text-rose-455 cursor-pointer rounded-lg px-3 text-slate-500 transition-colors hover:bg-rose-100 hover:text-rose-600 dark:hover:bg-rose-500/10"
                                    title="Remove answer"
                                >
                                    <X size={16} />
                                </button>
                    ...
                    <div className="mt-4">
                        <button
                            onClick={addAnswer}
                            className="flex cursor-pointer items-center gap-2 rounded-lg bg-indigo-50 px-3 py-2 text-xs font-semibold text-indigo-600 transition-colors hover:bg-indigo-100 hover:text-indigo-700 dark:bg-indigo-500/10 dark:text-indigo-400 dark:hover:text-indigo-300"
                        >
                            <Plus size={14} />
                            Add Option
                        </button>
