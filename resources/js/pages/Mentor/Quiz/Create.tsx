        ...
        <AppLayout>
            ...
            >
                <div className="mx-auto w-full space-y-6 sm:space-y-8">
                    {/* HEADER */}
                    <header className="relative w-full overflow-hidden rounded-xl border border-slate-300 bg-white px-6 py-5 shadow-sm backdrop-blur-xl dark:border-slate-800/60 dark:bg-slate-900/50 dark:shadow-lg">
                        {/* Ambient Glow Motif */}
                        <div
