...
import { ChevronRight, ArrowRight, Gem, Headset, LayoutGrid, Menu, MessageCircle, Music,  Slack, Users, X, Zap, Sparkles } from "lucide-react";
            ...
            <div className="relative min-h-screen w-full overflow-x-hidden bg-white text-[#1e293b] dark:bg-[#020202] dark:text-slate-100 font-sans antialiased transition-colors duration-300 2xl:max-w-[1780px] 2xl:mx-auto">
                ...
                <div className="relative z-10 container mx-auto px-4 md:px-6">
                  ...
                  {/* ================= MOBILE TITLE (SM ONLY) ================= */}
                    ...
                    {/* ARROW 1 */}
                    <picture>
                    <source srcSet="/images/arrow/curve1.png" media="(prefers-color-scheme: dark)" />
                    <img src="/images/arrow/curve1-black.png"
                    className="absolute
                    ...
                    <picture>
                    <source srcSet="/images/arrow/arrow1.png" media="(prefers-color-scheme: dark)" />
                    <img src="/images/arrow/arrow1-black.png"
                    className="absolute
