                        ...
                        <div className="mb-6 flex items-center gap-3 rounded-xl border border-emerald-500/40 bg-emerald-500/10 p-4 text-emerald-300">
                            ...
                            <div className="text-xs leading-relaxed">
                                <span className="font-bold text-emerald-400">
                                    Course sedang Live & Dipelajari Siswa.
                                </span>
                                <br />
                                Anda dapat langsung menambah atau memperbarui
                                kurikulum. Materi baru yang Anda susun akan
                                tersimpan sebagai draf sampai Anda siap
                                menerbitkannya tanpa menginterupsi pembelajaran
                                siswa.
                            </div>
                        </div>
                    )}
