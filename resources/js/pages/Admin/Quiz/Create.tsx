        ...
        <AppLayout>
            <div className="min-h-screen bg-slate-50 dark:bg-gradient-to-br dark:from-[#020617] dark:via-[#020617] dark:to-black text-slate-800 dark:text-white p-4 sm:p-6 lg:p-8">
                <div className="w-full mx-auto space-y-6 sm:space-y-8">
                    ...
                    {/* HEADER */}
                    <header
                        className="relative overflow-hidden rounded-xl px-6 py-5 bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800/60 backdrop-blur-xl shadow-sm dark:shadow-lg w-full"
                        style={{
                            backgroundImage: `
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col gap-2">
                            <button
                                ...
                                className="flex items-center gap-2 text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-white transition-colors text-sm font-medium w-fit mb-2 cursor-pointer"
                            >
                                <ArrowLeft size={16} /> Back
                            </button>

                            {/* Badge */}
                            <div className="inline-flex w-fit items-center gap-1.5 rounded border border-indigo-500/20 dark:border-indigo-500/30 bg-indigo-500/10 px-2.5 py-1">
                                <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-indigo-500 dark:bg-indigo-400" />
                                <span className="text-[10px] font-bold uppercase tracking-[0.12em] text-indigo-650 dark:text-indigo-400">
                                    Quiz Builder
                                </span>
                            </div>
                    ...
                    <div className="space-y-6">
                        {questions.length === 0 ? (
                            <div className="flex flex-col items-center justify-center p-12 border-2 border-dashed border-slate-305 dark:border-slate-800/60 rounded-2xl bg-white dark:bg-slate-900/20 text-center shadow-sm">
                                <HelpCircle size={48} className="text-slate-400 dark:text-slate-655 mb-4 opacity-50" />
                                <h3 className="text-lg font-medium text-slate-750 dark:text-slate-300 mb-1">No questions yet</h3>
                    ...
                    {questions.length > 0 && (
                        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 bg-white dark:bg-slate-900/50 p-6 rounded-2xl border border-slate-200 dark:border-slate-800/60 backdrop-blur-xl shadow-sm dark:shadow-lg">
                            <button
                                onClick={addQuestion}
                                className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-slate-50 hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-650 dark:text-slate-300 hover:text-slate-800 dark:hover:text-white border border-slate-300 dark:border-slate-700 transition-colors font-medium text-sm cursor-pointer"
                            >
                                <Plus size={16} />
        ...
        <div className="bg-white dark:bg-slate-900/40 backdrop-blur-md border border-slate-300 dark:border-slate-800/80 rounded-2xl overflow-hidden shadow-sm dark:shadow-xl transition-all duration-300 hover:border-slate-400 dark:hover:border-slate-700/80">
            ...
            <div className="flex justify-between items-center bg-slate-50 dark:bg-slate-950/50 p-4 border-b border-slate-200 dark:border-slate-800/60">
                <div className="flex items-center gap-3">
                    <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-indigo-500/10 text-indigo-650 dark:text-indigo-400 font-bold text-sm">
                        {index + 1}
                    </span>
            ...
            <div className="p-5 sm:p-6 space-y-6">
                ...
                {/* IMAGE UPLOAD */}
                <div>
                    <label className="block text-xs font-semibold text-slate-550 dark:text-slate-400 mb-1.5 ml-1">Attach Media (Optional)</label>
                    <div className="flex items-start gap-4">
                        <label className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:hover:bg-slate-700 text-sm text-slate-655 dark:text-slate-300 w-fit cursor-pointer transition-colors group">
                            <ImageIcon size={16} className="text-slate-400 group-hover:text-indigo-500 dark:group-hover:text-indigo-400 transition-colors" />
                        ...
                        {data.media_file && (
                            <span className="text-sm text-slate-550 dark:text-slate-400 py-2.5 truncate max-w-[200px] sm:max-w-xs">
                        ...
                        {data.media_url && (
                            <button
                                ...
                                className="p-2.5 text-rose-500 hover:bg-rose-500/10 rounded-xl transition-colors ml-auto cursor-pointer"
                                title="Remove Image"
                            >
                                <X size={16} />
                            </button>
                ...
                <div className="pt-4 border-t border-slate-200 dark:border-slate-800/60">
                    <div className="flex justify-between items-center mb-4">
                        <label className="block text-xs font-semibold text-slate-550 dark:text-slate-400 ml-1">Possible Answers</label>
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className={`flex items-center justify-center px-3 sm:px-4 rounded-lg transition-colors ${a.is_correct
                                            ...
                                            : 'bg-slate-200/60 dark:bg-slate-805 hover:bg-slate-300/80 dark:hover:bg-slate-700 text-slate-400'
                                        }`}
                                ...
                                <button
                                    ...
                                    className="px-3 text-slate-400 dark:text-slate-550 hover:text-rose-650 dark:hover:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-500/10 rounded-lg transition-colors cursor-pointer"
                                    title="Remove answer"
                                >
                                    <X size={16} />
                                </button>
                    ...
                    <div className="mt-4">
                        <button
                            onClick={addAnswer}
                            className="flex items-center gap-2 text-xs font-semibold text-indigo-650 dark:text-indigo-400 hover:text-indigo-750 dark:hover:text-indigo-300 hover:bg-indigo-50 dark:hover:bg-indigo-500/10 px-3 py-2 rounded-lg transition-colors cursor-pointer"
                        >
                            <Plus size={14} />
                            Add Option
                        </button>
