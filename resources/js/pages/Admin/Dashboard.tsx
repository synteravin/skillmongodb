...
interface RecentActivity {
    id: string;
    type: 'enrollment' | 'submission' | 'forum';
    title: string;
    time: string;
    timestamp: number;
}
                    ...
                    <section className="space-y-3">
                        ...
                        {actionRequired.total_alerts > 0 ? (
                            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
                                ...
                                >
                                    <div>
                                        ...
                                        <h3 className="mt-3 text-sm font-bold text-slate-800 dark:text-white">
                                            Pengajuan Proyek Kelulusan
                                        </h3>
                                        <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
                                            Proyek akhir cabang karir yang diajukan siswa untuk kelulusan dan penerbitan sertifikat.
                                        </p>
                                    </div>
                                ...
                                >
                                    <div>
                                        <div className="flex items-center justify-between">
                                            ...
                                            >
                                                {actionRequired.quest_flags > 0
                                                    ? `${actionRequired.quest_flags} Sengketa`
                                                    : '0 Sengketa'}
                                            </span>
                                        </div>
                                        <h3 className="mt-3 text-sm font-bold text-slate-800 dark:text-white">
                                            {actionRequired.quest_flags > 0
                                                ? 'Sengketa Quest Pending'
                                                : 'Integritas Quest'}
                                        </h3>
                                        <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
                                            {actionRequired.quest_flags > 0
                                                ? 'Pekerjaan quest dilaporkan bermasalah dan membutuhkan arbitrase admin.'
                                                : 'Semua quest berjalan normal. Tidak ada laporan sengketa aktif.'}
                                        </p>
                                    </div>
                                    <div className="mt-4 pt-3 border-t border-slate-200/60 dark:border-slate-800/60">
                                        <Link
                                ...
                                {/* Alert 3: Pending Quests Approval */}
                                <div
                                    className={`relative flex flex-col justify-between overflow-hidden rounded-xl border p-4 transition-all duration-200 ${
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
                                            Pengajuan quest baru menanti
                                            verifikasi sebelum dirilis ke siswa.
                                        </p>
                                    </div>
                                    <div className="mt-4 pt-3 border-t border-slate-200/60 dark:border-slate-800/60">
                                        <Link
