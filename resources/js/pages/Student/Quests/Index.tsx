                                                ...
                                                <div className="min-w-0 space-y-1">
                                                    <div className="flex items-center gap-2 flex-wrap">
                                                        <span className={`px-2 py-0.5 rounded text-[8px] font-bold font-['Orbitron'] uppercase tracking-wider ${
                                                            ...
                                                            {item.status === 'completed' ? 'Selesai' : item.status === 'approved' ? 'Disetujui' : item.status === 'submitted' ? 'Ditinjau' : item.status === 'ongoing' ? 'Berjalan' : item.status === 'expired' ? 'Kadaluarsa' : 'Bidding'}
                                                        </span>
