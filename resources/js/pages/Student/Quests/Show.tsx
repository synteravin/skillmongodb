                        ...
                        {activeTab === 'project' && (
                            <div className="space-y-6">
                                ...
                                {isCreator ? (
                                    ...
                                    /* 3. PROSPECTIVE BIDDER / PROPOSAL PANEL */
                                    <div className="space-y-5 rounded-2xl border border-slate-200 bg-white/70 p-6 shadow-md backdrop-blur-md transition-all duration-300 dark:border-slate-800/80 dark:bg-[#0c122c]/40">
                                        <div className="flex items-center justify-between border-b border-slate-100 pb-3 dark:border-slate-800">
                                            <h3 className="font-['Orbitron'] text-sm font-bold tracking-wider text-slate-800 uppercase dark:text-blue-200">
                                        ...
                                        {myBid ? (
                                            <div className="space-y-4 font-['Oxanium']">
                                                <div className={`flex flex-col gap-1.5 rounded-xl border p-4 text-center ${
                                                    myBid.status === 'rejected'
                                                        ? 'border-red-500/25 bg-red-500/10 text-red-600 dark:text-red-400'
                                                        : 'border-amber-500/25 bg-amber-500/10 text-amber-600 dark:text-amber-400'
                                                }`}>
                                                    <span className="block font-['Orbitron'] text-xs font-bold tracking-wider uppercase">
                                                        {myBid.status === 'rejected' ? 'Penawaran Ditolak' : 'Penawaran Sedang Ditinjau'}
                                                    </span>
                                                    <p className="text-xs leading-relaxed text-slate-500 dark:text-blue-300/60">
                                                        {myBid.status === 'rejected'
                                                ...
                                                <div className="space-y-3.5 rounded-xl border border-slate-200 bg-slate-50/50 p-4 text-xs dark:border-slate-800 dark:bg-black/20">
                                                    <div className="grid grid-cols-2 gap-4">
                                                        <div>
                                                            <strong className="block text-[10px] tracking-wider text-slate-400 uppercase">Harga Penawaran</strong>
                                                            <span className="font-semibold text-slate-700 dark:text-slate-200">Rp {myBid.bid_amount.toLocaleString('id-ID')}</span>
                                                        </div>
                                                        <div>
                                                            <strong className="block text-[10px] tracking-wider text-slate-400 uppercase">Waktu Pengajuan</strong>
                                                            <span className="font-semibold text-slate-700 dark:text-slate-200">{formatDate(myBid.created_at)}</span>
                                                        </div>
                                                    </div>
                                                    
                                                    <div className="border-t border-slate-200/50 pt-2 dark:border-slate-800/50">
                                                        <strong className="block text-[10px] tracking-wider text-slate-400 uppercase">Proposal Anda</strong>
                                                        <p className="mt-1 leading-relaxed text-slate-650 dark:text-slate-350">{myBid.proposal}</p>
                                                    </div>

                                                    <div className="grid grid-cols-2 gap-2 border-t border-slate-200/50 pt-2 dark:border-slate-800/50">
                                                        {myBid.cv && (
                                                            <a href={myBid.cv.startsWith('http') ? myBid.cv : '#'} target="_blank" rel="noopener noreferrer" className="rounded bg-slate-100 py-1.5 text-center text-[10px] font-bold text-slate-600 hover:bg-slate-200 dark:bg-slate-800/50 dark:text-indigo-300">
                                                                Tautan CV
                                                            </a>
                                                        )}
                                                        {myBid.portfolio && (
                                                            <a href={myBid.portfolio.startsWith('http') ? myBid.portfolio : '#'} target="_blank" rel="noopener noreferrer" className="rounded bg-slate-100 py-1.5 text-center text-[10px] font-bold text-slate-600 hover:bg-slate-200 dark:bg-slate-800/50 dark:text-indigo-300">
                                                                Tautan Portofolio
                                                            </a>
                                                        )}
                                                    </div>
                                                ...
                                                {myBid.status !== 'rejected' && (
                                                    <button
                                                        ...
                                                        className="w-full flex items-center justify-center gap-1.5 cursor-pointer rounded-xl bg-indigo-600 py-2.5 font-['Orbitron'] text-xs font-bold tracking-wider text-white uppercase shadow-md transition-all hover:bg-indigo-700"
                                                    >
                                                        <MessageSquare size={14} />
                                                        Chat Pembuat Quest
                                                    </button>
                                            ...
                                            <form onSubmit={handleBidSubmit} className="space-y-4 font-['Oxanium']">
                                                <div className="space-y-1.5">
                                                    ...
                                                    />
                                                    {errors.bid_amount && (
                                                        <p className="text-xs font-semibold text-red-500">{errors.bid_amount}</p>
                                                    )}
                                                </div>

                                                <div className="space-y-1.5">
                                                    <label className="text-[10px] font-bold text-slate-500 uppercase dark:text-slate-400">
                                                        Proposal / Penjelasan Kemampuan <span className="text-red-500">*</span>
                                                    </label>
                                                    <textarea
                                                        required
                                                    ...
                                                    />
                                                    {errors.proposal && (
                                                        <p className="text-xs font-semibold text-red-500">{errors.proposal}</p>
                                                    )}
                                                </div>
                                                ...
                                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                                    <div className="space-y-1.5">
                                                        ...
                                                        />
                                                        {errors.cv && (
                                                            <p className="text-xs font-semibold text-red-500">{errors.cv}</p>
                                                        )}
                                                    </div>
                                                    ...
                                                    <div className="space-y-1.5">
                                                        ...
                                                        />
                                                        {errors.portfolio && (
                                                            <p className="text-xs font-semibold text-red-500">{errors.portfolio}</p>
                                                        )}
                                                    </div>
                                                </div>
