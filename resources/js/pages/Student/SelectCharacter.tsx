  ...
  return () => clearTimeout(startDelay);
    ...
    return (
            <>
                ...
                {/* Main Background */}
                <div className="relative h-screen bg-[#020202] text-white selection:bg-indigo-500/30 font-primary overflow-hidden">
                    ...
                    {/* Blue Glow */}
                    <div className="absolute top-[20%] left-[-10%] w-[500px] h-[500px] bg-blue-500/30 rounded-full blur-[160px]" />
                    {/* Yellow Glow */}
                    ...
                    <div className="relative z-10 flex flex-col h-full md:hidden">
                        ...
                        <div className="flex-shrink-0 flex flex-col items-center justify-center pt-4 pb-2 px-4">
                            ...
                            <div className="relative flex items-center justify-center w-full">
                                ...
                                <AnimatePresence initial={false} custom={direction} mode="wait">
                                    <motion.div
                                        ...
                                        className="relative w-[130px] h-[175px] rounded-[20px] p-[2px] overflow-hidden
                                        bg-[linear-gradient(45deg,#1e3a8a_0%,#1e3a8a_25%,transparent_60%,#facc15_100%)]"
                                    >
                                        <div className="absolute inset-[2px] rounded-[18px] bg-[#0a0a0f] overflow-hidden">
                                            <div
                                            ...
                                            />
                                            <div className="absolute z-[1] top-[15%] left-[10%] w-[150px] h-[100px] bg-gradient-to-t from-blue-800 to-transparent blur-[40px] -rotate-45 scale-x-[1.6]" />
                                            <motion.img
                        ...
                        <div className="flex-1 min-h-0 mx-3 mb-3">
                            <AnimatePresence mode="wait">
                                <motion.div
                                    ...
                                    className="h-full rounded-[10px] border border-l-[3px] border-b-2 border-b-[#3B28F6] border-l-[#3B28F6] bg-[#070927] relative overflow-hidden flex flex-col"
                                >
                                    <div className="absolute -top-10 -right-10 w-32 h-32 bg-indigo-500/10 rounded-full blur-3xl pointer-events-none" />

                                    {/* Scrollable content */}
                                    <div className="flex-1 overflow-y-auto px-4 pt-4 pb-2 custom-scrollbar relative z-10 space-y-4">

                                        {/* Name + tags row */}
                                        <div className="flex items-center justify-between gap-2">
                                            <h1 style={{ fontFamily: "Orbitron" }} className="text-2xl font-black tracking-widest text-blue-50 uppercase">
                                                {selected.name}
                                            </h1>
                                            <div className="flex flex-wrap gap-1 justify-end">
                                                {(selected.character_type || []).map((type, i) => (
                                                    <span
                                                        ...
                                                        className="px-2 py-0.5 rounded-sm bg-[#3B28F6]/20 border border-[#4F46E5] text-[#A096FF] text-[9px] tracking-[0.15em] uppercase"
                                                    >
                                                        {type}
                                                    </span>
                                                ))}
                                        ...
                                        {/* Tagline */}
                                        <p style={{ fontFamily: "Oxanium" }} className="text-[#B3B3B3] text-xs leading-relaxed -mt-2">
                                            "{selected.tagline}"
                                        </p>
                                        ...
                                        <div className="flex gap-4">
                                            {(selected.abilities || ['Visual Learn', 'Fast', 'Strategic', 'Practical']).slice(0, 4).map((ability, i) => (
                                                <div key={i} className="flex flex-col items-center gap-1">
                                                    <div className="w-9 h-9 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-white/70">
                                                        {getIcon(ability)}
                                                    </div>
                                                    <span className="text-[8px] font-bold text-white/40 uppercase tracking-wider text-center">{ability}</span>
                                                </div>
                                            ))}
                                        </div>
                                        ...
                                        {/* Guide Power — compact */}
                                        <div className="flex gap-3 items-center p-3 rounded-xl border border-[#3B28F6] bg-[#020101]/60 shadow-[0_0_11px_rgba(59,130,246,0.2)]">
                                            <div className="w-9 h-9 shrink-0 rounded-full bg-[#6042FF]/40 border border-[#810AC6]/70 flex items-center justify-center">
                                                <Layers className="w-4 h-4 text-white" />
                                            </div>
                                            <div className="min-w-0">
                                                <h3 style={{ fontFamily: "Orbitron" }} className="bg-gradient-to-r from-[#3B28F6] to-purple-500 bg-clip-text text-transparent text-[9px] font-black uppercase tracking-widest mb-0.5">
                                                    Guide Power: {selected.guide_power?.title || 'Unknown'}
                                                </h3>
                                                <p style={{ fontFamily: "Oxanium" }} className="text-[#B3B3B3]/80 text-[11px] leading-relaxed line-clamp-2">
                                        ...
                                        <div className="p-3 rounded-xl border border-[#3B28F6] bg-[#020101]/60 shadow-[0_0_11px_rgba(59,130,246,0.2)]">
                                            <h3 style={{ fontFamily: "Orbitron" }} className="text-[#FACC15] text-[9px] tracking-widest uppercase mb-3">
                                                Starter Bonus
                                            </h3>
                                            <div className="grid grid-cols-2 gap-2">
                                                <div className="flex items-center gap-2">
                                                    <Checkbox checked className="border-yellow-500/50 data-[state=checked]:bg-yellow-500 data-[state=checked]:text-black w-3 h-3" />
                                                    <span style={{ fontFamily: "Oxanium" }} className="text-[10px] font-semibold text-yellow-400">
                                                        +{selected.system_bonus?.exp_boost || 15}% EXP
                                                    </span>
                                                </div>
                                                <div className="flex items-center gap-2">
                                                    <Checkbox checked className="border-amber-500/50 data-[state=checked]:bg-amber-500 data-[state=checked]:text-black w-3 h-3" />
                                                    <span style={{ fontFamily: "Oxanium" }} className="text-[10px] font-semibold text-amber-400">
                                                        +{selected.system_bonus?.gold_boost || 20}% Gold
                                                    </span>
                                                </div>
                                                <div className="flex items-center gap-2 opacity-40">
                                                    <Checkbox disabled className="bg-[#A34B1D] border-[#FACC15] w-3 h-3" />
                                                    <span style={{ fontFamily: "Oxanium" }} className="text-[10px] text-[#FACC15]">Focus Boost</span>
                                                </div>
                                                <div className="flex items-center gap-2 opacity-40">
                                                    <Checkbox disabled className="bg-[#A34B1D] border-[#FACC15] w-3 h-3" />
                                                    <span style={{ fontFamily: "Oxanium" }} className="text-[10px] text-[#F0F0F0]">Mind <span className="text-[#FACC15]">Sync</span></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex flex-wrap gap-1.5">
                                            {(selected.personality || []).map((trait, i) => (
                                                <span
                                                    key={i}
                                                    style={{ fontFamily: "Oxanium" }}
                                                    className="px-3 py-1 rounded-full bg-[#1D215D] text-[#6041FF] border border-[#6041FF] text-[10px] font-semibold"
                                                >
                                                    {trait}
                                                </span>
                                            ))}
                                        ...
                                        <div className="rounded-xl border border-[#3B28F6] bg-[#020101]/60 p-3 shadow-[0_0_11px_rgba(59,130,246,0.2)]">
                                            <div className="flex items-center gap-2 mb-2">
                                                ...
                                                <h2 style={{ fontFamily: "Orbitron" }} className="text-[10px] font-bold text-slate-200 tracking-widest uppercase">Origin Story</h2>
                                            </div>
                                            <div className="text-slate-400 text-[11px] leading-relaxed">
                                                {selected.backstory
                                                    ? <p className="whitespace-pre-line">{selected.backstory}</p>
                                                    : <p>History lost in the records of time.</p>
                                                }
                                            </div>
                                            <div className="mt-3 pl-3 border-l border-white/20 italic text-slate-400 text-[10px]">
                                        ...
                                        <div className="rounded-xl border border-[#3B28F6] bg-[#020101]/60 p-3 text-center shadow-[0_0_11px_rgba(59,130,246,0.2)]">
                                            <p style={{ fontFamily: "Orbitron" }} className="text-[11px] font-semibold text-slate-200 leading-relaxed tracking-wide">
                                                "{selected.quote || 'Ready for adventure.'}"
                                            </p>
                                            <span className="text-slate-500 text-[10px] italic mt-1 block">— {selected.name}</span>
                                        </div>
                                    ...
                                    <div className="flex-shrink-0 p-3 border-t border-white/10">
                                        <button
                                            ...
                                            style={{ fontFamily: "Oxanium" }}
                                            className="w-full py-3 rounded-sm font-black text-xs uppercase tracking-widest text-white
                    ...
                    {/* ===================== DESKTOP LAYOUT ===================== */}
                    <div className="relative z-10 container mx-auto px-4 py-8 lg:py-12 hidden md:flex flex-col min-h-screen justify-center">
                            ...
                            <div className="w-full md:w-[260px] lg:w-[420px] flex flex-col items-center">
                                <div className="relative group perspective-1000">
                                    <button
                                        ...
                                        w-12 h-12 rounded-full bg-white/5 backdrop-blur-md border border-white/10
                                        hover:border-indigo-500/50 hover:bg-indigo-500/10
                                        ...
                                        <div className="flex-1 overflow-y-auto p-8 lg:p-8 custom-scrollbar relative z-10">
                                            <div className="flex flex-col gap-6 mb-8">
                                                <div className="flex flex-wrap gap-3">
                                                    {(selected.character_type || []).map((type, i) => (
                                                        <span key={i} style={{ fontFamily: "Oxanium" }}
                                            ...
                                            <div className="mb-8 group">
                                                <div className="p-5 rounded-xl border border-[#3B28F6] bg-[#020101]/60 flex gap-4 items-center shadow-[0_0_11px_rgba(59,130,246,0.35)]">
                                                    ...
                                                    <div>
                                                        <h3 style={{ fontFamily: "Orbitron" }} className="bg-gradient-to-r from-[#3B28F6] to-purple-500 bg-clip-text text-transparent text-xs font-black uppercase tracking-widest mb-1">
                                                            Guide Power: {selected.guide_power?.title || 'Unknown'}
                                                        </h3>
                                            ...
                                            <div className="mb-8 rounded-2xl border border-[#3B28F6] bg-[#020101]/60 p-6 shadow-[0_0_11px_rgba(59,130,246,0.35)]">
                                                <div className="flex items-center gap-3 mb-4">
                                                    ...
                                                    <h2 className="text-lg font-semibold text-slate-200 tracking-wide">Origin Story</h2>
                                                </div>
                                                <div className="text-slate-400 text-sm leading-relaxed space-y-4">
                                                    {selected.backstory ? <p className="whitespace-pre-line">{selected.backstory}</p> : <p>History lost in the records of time.</p>}
                                                </div>
                                            ...
                                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
                                                <div className="rounded-2xl border border-[#3B28F6] bg-[#020101]/60 p-6 shadow-[0_0_11px_rgba(59,130,246,0.35)]">
                                                    <h3 style={{ fontFamily: "Orbitron" }} className="text-[#B3B3B3]/80 text-sm font-bold tracking-widest uppercase mb-6 lg:text-base">Personality</h3>
                                                    <div className="flex flex-wrap gap-4">
                                                        {(selected.personality || []).map((trait, i) => (
                                                            <span key={i} style={{ fontFamily: "Oxanium" }} className="px-5 py-2 rounded-full bg-[#1D215D] text-[#6041FF] border border-[#6041FF] text-sm font-semibold">{trait}</span>
                                                        ))}
                                                    </div>
                                                </div>
                                                <div className="rounded-2xl border border-[#3B28F6] bg-[#020101]/60 p-6 shadow-[0_0_11px_rgba(59,130,246,0.35)]">
                                                    <h3 style={{ fontFamily: "Orbitron" }} className="text-[#FACC15] text-lg tracking-widest uppercase mb-6 lg:text-base">Starter Bonus</h3>
                                                    <div className="space-y-4">
                                                        <div className="flex items-center gap-3 pointer-events-none">
                                                            ...
                                                            <span style={{ fontFamily: "Oxanium" }} className="text-sm font-semibold text-yellow-400 tracking-wide">+{selected.system_bonus?.exp_boost || 15}% Learning EXP</span>
                                                        </div>
                                                        <div className="flex items-center gap-3 pointer-events-none">
                                                            <Checkbox checked className="border-amber-500/50 data-[state=checked]:bg-amber-500 data-[state=checked]:text-black" />
                                                            <span style={{ fontFamily: "Oxanium" }} className="text-sm font-semibold text-amber-400 tracking-wide">+{selected.system_bonus?.gold_boost || 20}% Gold Reward</span>
                                                        </div>
                                                        <div className="flex items-center gap-3 opacity-50 cursor-not-allowed">
                                                            <Checkbox disabled className="bg-[#A34B1D] border-[#FACC15]" />
                                                            <span style={{ fontFamily: "Oxanium" }} className="text-sm font-medium text-[#FACC15]">Focus Boost <span className="text-[#F0F0F0]">Session</span></span>
                                                        </div>
                                                        <div className="flex items-center gap-3 opacity-50 cursor-not-allowed">
                                                            <Checkbox disabled className="bg-[#A34B1D] border-[#FACC15]" />
                                                            <span style={{ fontFamily: "Oxanium" }} className="text-sm font-medium text-[#F0F0F0]">Mind <span className="text-[#FACC15]">Sync</span></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="rounded-2xl border border-[#3B28F6] bg-[#020101]/60 p-8 text-center shadow-[0_0_11px_rgba(59,130,246,0.35)]">
                                                <p style={{ fontFamily: "Orbitron" }} className="text-xl font-semibold text-slate-200 leading-relaxed tracking-wide">
                                                    "{selected.quote || 'Ready for adventure.'}"
                                                </p>
                                                <div className="mt-4 relative flex items-center justify-center">
                                                    <span className="text-slate-500 text-xs italic">— {selected.name}</span>
                                                    <div className="absolute bottom-[-6px] w-24 h-[3px] bg-purple-500/50 blur-md rounded-full" />
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <AnimatePresence>
                        {showModal && (
                            <motion.div
                                ...
                                animate={{ opacity: 1 }}
                                exit={{ opacity: 0 }}
                                className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-md p-4 lg:p-6 xl:p-8"
                            >
                                <motion.div
                                    ...
                                    className="bg-[#020202] border border-[#3B28F6]/80 rounded-xs p-6 md:p-8 lg:p-10 xl:p-12 w-full max-w-xl text-center relative overflow-hidden shadow-[0_0_30px_rgba(59,130,246,0.6)]"
                                >
                                    ...
                                    <h1 className="text-3xl md:text-4xl text-white tracking-widest uppercase">Confirm Selection</h1>
                                    <p className="text-[#3B28F6] text-xs tracking-[0.2em] uppercase mt-2 mb-6">System Alert: Action Final</p>
                                    <div className="flex items-center justify-center gap-3 mb-6">
                                        <div className="h-[1px] w-24 bg-[#3B28F6]" />
                                        <div className="w-3 h-3 rotate-45 border-2 border-blue-500" />
                                        <div className="h-[1px] w-24 bg-[#3B28F6]" />
                                    </div>
                                    <div className="rounded-xl border border-blue-500/30 bg-blue-900/10 p-5 mb-6 text-left">
                                        <p className="text-yellow-400 font-semibold text-center mb-3">Warning: Irreversible Action</p>
                                        <p className="text-slate-100 text-sm md:text-base leading-relaxed font-mono">
                                            {typedText}<span className="animate-pulse">|</span>
                                        </p>
                                    </div>
                                    <div className="flex flex-col sm:flex-row gap-3">
                                        <button onClick={() => setShowModal(false)} className="px-6 py-3 rounded-sm bg-white/5 border border-white/10 text-white/80 flex-1 hover:bg-white/10">
                                            Cancel
                                        </button>
                                        <button onClick={handleSubmit} disabled={processing}
                                            className="px-6 py-3 rounded-sm text-[#6252FF] flex-1 bg-[#3B28F6]/20 border border-[#4F46E5] shadow-[0_0_12px_rgba(139,92,246,0.6)] hover:shadow-[0_0_20px_rgba(139,92,246,0.8)]">
                                            {processing ? "Deploying..." : "Deploy"}
                                        </button>
                                    </div>
                                    <p className="text-[10px] text-slate-500 mt-8 tracking-wide">SYSTEM ID: SKILLVENTURA CHARACTER</p>
                                </motion.div>
                            </motion.div>
                        )}
                    </AnimatePresence>
