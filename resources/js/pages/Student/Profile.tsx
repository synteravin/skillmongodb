        ...
        <div className="w-screen h-screen bg-[#0c0c14] text-white overflow-hidden flex flex-col">
            ...
            <form onSubmit={submit} className="relative z-10 flex-1 flex flex-col md:flex-row gap-3 md:gap-4 px-4 md:px-8 pb-4 min-h-0 overflow-hidden">
                ...
                <div className="flex-1 flex flex-col gap-2 min-h-0 min-w-0">
                    ...
                    {/* OPERATOR DATA */}
                    <div
                        className="relative flex-1 flex flex-col min-h-0 min-w-0 overflow-hidden border-2 border-[#3B28F6] bg-[#090915] p-1 md:p-5 lg:p-5 xl:p-5"
                        style={{ boxShadow: '0 0 20px rgba(59,40,246,0.12)' }}
                    >
                        {/* top glow line */}
                        <div
                        ...
                        {/* TITLE */}
                        <h3 className="flex-shrink-0 font-['Orbitron'] text-[#00d4ff] text-sm md:text-base xl:text-lg font-bold tracking-[3px] mb-1 md:mb-1 flex items-center gap-2">
                        ...
                        <div className="flex-1 overflow-y-auto md:overflow-hidden pr-1 md:pr-0 flex flex-col justify-between gap-2 xl:gap-2">
                            ...
                            {/* RANK CARD */}
                            <div className="relative flex flex-col sm:flex-row items-start sm:items-center gap-3 rounded-lg border border-[#3B28F6]/60 bg-[#3B28F6]/5 p-2.5 md:p-2 xl:p-8 overflow-hidden">
